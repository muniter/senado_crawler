...
CREATE TABLE IF NOT EXISTS "Cuatrenio" (
...
CREATE TABLE IF NOT EXISTS "ProyectoSenado" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "ProyectoSenadoDetalles" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "ProyectosRelacionados" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "proyectoId" INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS "AutorProyectos" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "PonenteDebate" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "autorId" INTEGER NOT NULL,
    "proyectoId" INTEGER NOT NULL,
